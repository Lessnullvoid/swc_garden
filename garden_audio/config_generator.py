...
def _granular_sampling_config(dataset: dict, date_str: str,
                               base_dir: Path) -> dict:
    """Build config for the Microcosm-style granular sampling module.

    Uses a preset-blending system: 4 curated presets (deep_haze, warm_drift,
    cloud, shimmer) placed on an activity continuum.  A composite activity
